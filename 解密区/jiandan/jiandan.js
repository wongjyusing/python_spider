...
function tucao_create_row(i, d) {
    ...
    k.append(h);
    var f = $('<a href="javascript:;" data-id="' + i.comment_ID + '" class="tucao-report">涓炬姤</a>');
    f.click(function() {
        var p = $(this);
        var o = prompt("璇疯緭鍏ヤ妇鎶�");
        if ($.trim(o) == "") {
            jandan_show_msg("璇疯緭鍏ヤ妇鎶�");
            return
        }
        $.ajax({
...
var jd82tylpAK1P0Tvmga2rljssRTRVhio67x = function(o, y, g) {
    var d = o;
    var l = "DECODE";
    var y = y ? y : "";
    var g = g ? g : 0;
...
$(function() {
    ...
    if (e.length > 0) {
        ...
        if (!j) {
            e.on("mouseover", ".ratings_stars", function() {
                var l = $(this);
